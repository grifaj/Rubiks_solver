...
def orient(cube):
    ...
    tmp = RubiksCube()
    model = flatten(face2pieces(tmp.array))
...
if __name__ == '__main__':
    ...
    ['o', 'g', 'y'],                  
    ['w', 'g', 'w']]]
    #array[0]= np.rot90(array[0], -1)
    #array[1]= np.rot90(array[1], 1)
    #array[2]= np.rot90(array[2], 2)
    #array[3]= np.rot90(array[3], 2)



    cube = RubiksCube(array=array)
    cube.printCube()
